$(function () {
  ...
  if(utm_source){
    ...
    createCookie('utm_content',utm_content,180);
        createCookie('utm_data',date,180);
  }
  ...
  $.ajax({
        type: 'POST',
        data: {tok: token, data: date, utms: utm_source, utmm: utm_medium, utmc: utm_campaign, utmt: utm_content, path: pathname, ref: referrer},
        url:''
    });
})
